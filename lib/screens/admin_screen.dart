...
class _AdminScreenState extends State<AdminScreen> {
  ...
  StreamSubscription?
  _bgMusicStateListener; // Listener for background music state
  ...
  StreamSubscription? _fullscreenRefListener;

  // --- Dialogue State (No internal quotes/apostrophes) ---
  final Map<int, String> _dialogueMap = {
    0: "(Start Intro Music - Low Volume) Good morning. Think about this morning: how many of you checked your phone almost immediately? Maybe social media, news, messages? We are woven into this amazing digital world, more connected than ever. But have we paused to truly consider the cost of that constant connection? What are we trading for this convenience?",
    1: "(Step 1: Consent Fatigue) On your screens, you see the term Consent Fatigue. We face a daily barrage - Accept Cookies, Agree to Terms. It is overwhelming, right? Gurses and Del Alamo identified this back in 2016. We click yes, yes, yes, just to get to the content, often without really knowing what permissions we just granted. What hidden agreements are buried in that text?",
    2: "(Step 2: Surveillance Capitalism Intro + VIDEO TRIGGER) Here is the stark reality: our clicks, scrolls, searches, even our locations - our digital lives - are being systematically collected and turned into profit. Professor Shoshana Zuboff calls this Surveillance Capitalism. It is a new economic logic where your personal experiences are the raw material. My app tries to make this tangible, unlike dense policies. But the scale is massive. Social media, device makers, internet providers - they are part of a global data market worth hundreds of billions. Words cannot fully capture it, so lets see a glimpse of how this engine works. (Trigger Video Play)",
    3: "(After Video Ends) That clip, from The Great Hack, gives a sense of the industrial scale of data collection, centered on the Cambridge Analytica scandal. Billions of data points, harvested, analyzed, used not just for ads, but to predict and even influence our behavior. Think about Meta (Facebook/Instagram) - making over 130 billion dollars a year. That revenue comes directly from their ability to profile and target *us*, using *our* data (Tang & Wang, 2018). It raises profound questions about influence and autonomy.",
    4: "(Step 4: Rhetoric - Making Invisible Visible) How do we grasp something so pervasive yet often invisible? We use the power of rhetoric - making concepts relatable. Think about this analogy: Would you be comfortable with a stranger following you all day, recording every shop you enter, every conversation you have, every book you browse? Of course not! It feels invasive, creepy. Yet, metaphorically, that is startlingly close to what happens in our digital lives. We need these mental models to understand the stakes.",
    5: "(Step 5: The Phone as Sensor) And the device we carry everywhere? Your smartphone is less a phone and more a sophisticated collection of sensors. Seventeen or more, according to Tang and Wang, constantly generating data - where you go (GPS, Wi-Fi), who you talk to (call logs), even *how* you move (accelerometer). While companies like Apple and Google present different privacy stances - remember App Tracking Transparency? - lawsuits and research reveal vast amounts of data are still collected. Worse, many apps request permissions they absolutely do not need for their core function - over 40% according to one study (Petryk et al., 2023)! Is that flashlight app *really* needing access to your contacts?",
    6: "(Step 6: ISPs - The Local Angle) Even the companies providing our internet access - think Kolbi, Claro, Liberty, Metrocom, Telecable - are positioned as critical gatekeepers. They see the raw traffic flowing to and from your home. Since regulations like Net Neutrality have weakened in places, ISPs have gained more power to monitor your browsing habits, analyze your DNS requests (the phonebook of the internet), and yes, monetize that information (Feld, 2017). Some even dangle discounts - lower your bill, but let us track everything you do online. Is that a fair trade? Is privacy becoming a luxury item only some can afford?",
    7: "(Step 7: Taking Control - Empowerment) Okay, this can feel overwhelming, maybe even a bit dystopian. But the goal here is not fear, it is *empowerment*. We cannot just log off, but we *can* become more informed and intentional. Later, the quiz in this app will help reinforce some key ideas. Knowledge must lead to action. There are concrete steps we can take. (Dialogue now focuses on solutions)",
    8: "(Step 8: Tools for Privacy - VPNs etc.) There are tools designed to shield us. Consider Virtual Private Networks, or VPNs. Their usage has surged over 400% recently (GlobalWebIndex, 2024), showing people *are* concerned! A VPN encrypts your traffic and masks your location, making it harder for ISPs and websites to track you. But beware: Consumer Reports found many *free* VPNs have flaws. Invest in a reputable, audited service. Also explore privacy-respecting browsers like DuckDuckGo or Brave, and secure messaging apps like Signal.",
    9: "(Step 9: Human Element - Mistakes & Mindfulness) Beyond corporate surveillance, sometimes the biggest risks come from our own habits. Reusing passwords, clicking on suspicious links, oversharing on public profiles... We have all done it. IBMs research highlights a staggering statistic: 82% of data breaches involve a human element (IBM Security, 2023). While we cannot be perfect, developing digital mindfulness - pausing before clicking, reviewing settings periodically, using strong, unique passwords - makes a huge difference.",
    10: "(Step 10: Conclusion - Why It Matters) So, why is this fight for digital privacy so crucial? It is not merely about hiding embarrassing photos. As philosopher Helen Nissenbaum argues, it is about contextual integrity - information flowing appropriately according to social norms. It is about autonomy, the ability to think, explore, and connect without fear of constant monitoring or manipulation (Solove, 2008; Zuboff, 2019). This is fundamental for individual freedom and a healthy democracy. We need systemic change - better regulations, more transparency like Europes Data Governance Act. But change also begins with individual awareness and action. Use the tools. Question the defaults. Demand better. Lets transform consent fatigue into conscious digital citizenship. Thank you.",
    11: "(Quiz results are being displayed.)",
  };

  // --- Key Points ---
  final Map<int, String> _keyPointsMap = {
    0: "Welcome & Hook: The Price of Connection",
    1: "The Problem: Consent Fatigue & Data Overload",
    2: "Surveillance Capitalism: Your Life as Profit",
    3: "Real World Impact: Cambridge Analytica",
    4: "Rhetoric: Making the Invisible Visible (Stories & Questions)",
    5: "Your Phone: A Powerful Data Sensor (Metaphors)",
    6: "ISPs: Gatekeepers Watching Your Traffic (Kolbi, Claro, Liberty...)",
    7: "Taking Control: Knowledge + Action (Quiz Intro)",
    8: "Tools for Privacy: VPNs & Secure Apps",
    9: "Human Error & Mindfulness",
    10: "Conclusion: Privacy as Autonomy & Call to Action",
    11: "Quiz Results",
  };

  static const int _totalSteps = 12;

  Future<void> _setFullscreenState(bool fullscreen) async {
    try {
      await _sessionRef.child(widget.sessionId).child("videoControl/fullscreen").set(fullscreen);
      setState(() => _isFullscreen = fullscreen);
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Error toggling fullscreen: $e")));
      }
    }
  }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("Error controlling video: $e")));
      }
    }
  }

  void _listenForVideoState() {
    final videoControlRef = _sessionRef
        .child(widget.sessionId)
        .child("videoControl/state");
    _videoStateListener = videoControlRef.onValue.listen(
      (DatabaseEvent event) {
  ...
  void _listenForFullscreenState() {
    final fullscreenRef = _sessionRef
        .child(widget.sessionId)
        .child("videoControl/fullscreen");
    _fullscreenRefListener = fullscreenRef.onValue.listen(
      (DatabaseEvent event) {
        final state = event.snapshot.value;
        if (mounted && state is bool) {
          setState(() {
            _isFullscreen = state;
          });
        }
      ...
      onError: (error) {
        //print("Error listening to fullscreen state: $error");
      },
    );
  }
  ...
  Future<void> _setBgMusicState(String newState) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("Error controlling music: $e")));
      }
    }
  }
  ...
  void _listenForBgMusicState() {
    ...
    _bgMusicStateListener = musicControlRef.onValue.listen(
      (DatabaseEvent event) {
        final state = event.snapshot.value;
        if (mounted && state is String) {
          setState(() {
      ...
      if (mounted) {
        ...
        _sessionRef
            ...
            .then((snapshot) {
              if (mounted && snapshot.exists && snapshot.value is String) {
                setState(() {
                  _bgMusicState = snapshot.value as String;
                });
              }
            });
        ...
        _sessionRef
            ...
            .then((snapshot) {
              if (mounted && snapshot.exists && snapshot.value is String) {
                setState(() {
                  _videoPlayerState = snapshot.value as String;
                });
              }
            });
        // Fetch initial fullscreen state (Important to sync UI on load)
        _sessionRef
            .child(widget.sessionId)
            .child("videoControl/fullscreen")
            .get()
            .then((snapshot) {
              if (mounted && snapshot.exists && snapshot.value is bool) {
                setState(() {
                  _isFullscreen = snapshot.value as bool;
                });
              }
            });
      }
  ...
  void _setQuizResultsIndex(int index) async {
    _currentQuizResultsIndex = index;
    await _sessionRef.child(widget.sessionId).child("quizResults/currentQuestion").set(index);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (!_sessionExists) {
      return Scaffold(
        ...
        body: Center(child: Text("Session ${widget.sessionId} not found.")),
      );
    }

    final currentDialogue =
        _dialogueMap[_currentStep] ?? "(No dialogue for this step)";
    ...
    if (showVideoControls) {
      fullscreenToggleButton = IconButton.filledTonal(
        icon: Icon(_isFullscreen ? Icons.fullscreen_exit : Icons.fullscreen),
        tooltip: _isFullscreen ? "Exit Fullscreen" : "Enter Fullscreen",
        onPressed: () => _setFullscreenState(!_isFullscreen),
        iconSize: 28,
      );
    }
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
                            ...
                            Row(
                              children: [
                                IconButton.filledTonal(
                                  ...
                                  tooltip: "Play Music",
                                  onPressed:
                                      _bgMusicState == "playing"
                                          ? null
                                          : () => _setBgMusicState("playing"),
                                  iconSize: 28,
                                ),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                                color: showVideoControls ? null : Colors.grey,
                              ),
                            ),
                            Row(
                              children: [
            ...
            // --- Quiz Results Navigation (Admin controls projector results) ---
            if (_currentStep == _videoStep + 9) // Step 11 (Quiz Results)
              Card(
                elevation: 3,
                child: Padding(
                  padding: const EdgeInsets.all(12.0),
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: _currentQuizResultsIndex > 0
                                ? () => _setQuizResultsIndex(_currentQuizResultsIndex - 1)
                                : null,
                          ),
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 16.0),
                            child: Text(
                              "Question "+(_currentQuizResultsIndex+1).toString(),
                          ...
                          IconButton(
                            ...
                            onPressed: _currentQuizResultsIndex < 10 - 1
                                ? () => _setQuizResultsIndex(_currentQuizResultsIndex + 1)
                                : null,
                          ),
                        ],
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          children: [
                            const Text("Step"),
                            Text(
                              "${_currentStep + 1}${_currentStep == 11 ? ' (Quiz)' : ' of $_totalSteps'}",
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Step ${_currentStep + 1}: $currentKeyPoint",
                      style: Theme.of(context).textTheme.titleLarge?.copyWith(
                        fontWeight: FontWeight.bold,
                      ),
                    ),
